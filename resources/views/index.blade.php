...
<body>
                            ...
                            <tr>
                                <td width="500" valign="top">
                                    <table width="500" border="0" cellpadding="4" cellspacing="0" class="CRMText">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <font face="Arial, Helvetica, sans-serif" color="#000000" size="2">
                                                        <font color="#FF0000"><b>{username}</b></font>
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="customerID" id="customerID" value="" size="35" readonly="">
                                                ...
                                                <td colspan="2">
                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="1">
                                                        <div id="UserManagement">
                                                            <center><a href="#" class="usersaccounts">View/Modify/Delete Account Users</a></center>
                                                        </div>
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <font face="Verdana, Arial, Helvetica, sans-serif" color="#000000" size="1">
                                                        <div id="UserManagement">
                                                            <center><a href="#" class="linkedaccounts">View/Modify/Delete Linked Accounts</a></center>
                                                        </div>
                                                    </font>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td height="30">
                                                    <input name="Add_Line1" id="Add_Line1" value="" size="40">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Suburb</td>
                                                <td height="30">
                                                    <input name="Add_Suburb" id="Add_Suburb" value="" size="40">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td height="15">
                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input name="Add_City" id="Add_City" value="" size="40">
                                                                </td>
                                                                <td align="right" class="CRMText">&nbsp;&nbsp;&nbsp;Post&nbsp;Code&nbsp;&nbsp;</td>
                                                                <td height="30" class="CRMText">
                                                                    <input name="Add_PostCode" id="Add_PostCode" value="" size="6">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td height="9">
                                                    <input onclick="showPostalAddress();" name="PA_Same" type="checkbox" id="PA_Same" value="1" checked="">Same as physical address</td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div id="PostalAddressBox">
                                        <table width="500" border="0" cellpadding="4" cellspacing="0" class="CRMText">
                                            <tbody>
                                                <tr id="rowPostal_Line1">
                                                    <td width="130" align="right">Postal Address</td>
                                                    <td height="30">
                                                        <input name="Postal_Line1" id="Postal_Line1" value="" size="40">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">Postal Suburb</td>
                                                    <td height="30">
                                                        <input name="Postal_Suburb" id="Postal_Suburb" value="" size="40">
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td height="15">
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input name="Postal_City" id="Postal_City" value="" size="40">
                                                                    </td>
                                                                    <td align="right" class="CRMText">&nbsp;&nbsp;&nbsp;Post&nbsp;Code</td>
                                                                    <td height="30" class="CRMText">
                                                                        <input name="Postal_PostCode" id="Postal_PostCode" value="" size="6">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                    ...
                                    <table width="500" border="0" cellpadding="4" cellspacing="0" class="CRMText">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="Tel" id="Tel" value="" size="45" number="" #="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Fax</td>
                                                <td>
                                                    <input name="Fax" id="Fax" value="" size="45" number="" #="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Mobile</td>
                                                <td>
                                                    <input name="Mobile" id="Mobile" value="" size="45">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" valign="top" style="vertical-align:top;"><a href="mailto:">Email Address</a></td>
                                                <td>
                                                    <textarea name="Email" cols="55" rows="3" id="Email"></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Website</td>
                                                <td>
                                                    <input name="Website" id="Website" value="" size="32">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="submit" name="Save" class="submit_btn">Save profile</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table border="0" cellpadding="4" cellspacing="0" class="CRMText">
                                        <tbody>
                                            ...
                                            <tr id="rowAccChecked" class="SmartBuy-hide" style="display: table-row;">
                                                ...
                                                <td height="9">
                                                    <input name="AccChecked" type="checkbox" id="AccChecked" value="1" checked="">
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="SmartBuy-hide" style="display: table-row;">
                                                ...
                                                <td>
                                                    <input name="DeregSpecial" type="checkbox" id="DeregSpecial" value="1">
                                                    <div id="DeregDiv" style="display: none;">
                                                        <a href="#" class="addderegnotelink">Add Dereg Special Instruction Note</a>
                                                        <br>
                                                        <br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <textarea name="PeopleToDealWith" cols="55" rows="5" id="PeopleToDealWith"></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="style16">
                                                                    <select name="PaymentDueTime" id="PaymentDueTime">
                                                                        <option value=""></option>
                                                                        @for ($i = 1; $i
                                                                        < 32; $i++) <option value="{{$i}}">{{$i}} Day</option>
                                                                            @endfor
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div id="paymentduemessage" style="background-color:red;display:inline;color:#FFFFFF"></div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <table border="0" cellpadding="2" cellspacing="0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <textarea name="FlaggedNotes" cols="40" rows="5" id="FlaggedNotes" class="FlagAcc"></textarea>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">McCulloughs&nbsp;Debt</td>
                                                                    <td>
                                                                        <input name="DebtNotesMcLtd" id="DebtNotesMcLtd" value="" size="20" maxlength="30" class="FlagAcc">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">FastTrack&nbsp;Debt</td>
                                                                    <td>
                                                                        <input name="DebtNotesFastTrack" id="DebtNotesFastTrack" value="" size="20" maxlength="30" class="FlagAcc">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="right">Other&nbsp;Debt</td>
                                                                    <td>
                                                                        <input name="DebtNotesOther" id="DebtNotesOther" value="" size="20" maxlength="30" class="FlagAcc">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <tr>
                                                <td align="right">Release MR2A from compliance center
                                                    <br><small>(required for online MR2A release - selected compliance centre must also have valid email address and Max MR2A released without payment must be set)</small></td>
                                                <td valign="top">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#" class="addmr2aspecialinstructionnotelink">Add MR2A Special Instruction Note</a>
                                                    <br>
                                                    <br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="AFD" type="checkbox" id="AFD" value="1">
                                                </td>
                                            </tr>
                                            <tr>
                                            </tr>
                                                ...
                                                <td colspan="2">
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="right">&nbsp;JPY&nbsp;
                                                                    <input name="AverageTradingZoneJPY" id="AverageTradingZoneJPY" value="0" size="20" disabledformboxes="DISABLEDFORMBOXES" disabled="">
                                                                </td>
                                                                <td align="right">&nbsp;JPY&nbsp;
                                                                    <input name="StatementLimitYEN" id="StatementLimitYEN" value="0" size="20" disabledformboxes="DISABLEDFORMBOXES" disabled="">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right"> &nbsp;NZD&nbsp;
                                                                    <input name="AverageTradingZoneNZD" id="AverageTradingZoneNZD" value="250,000" size="20" disabledformboxes="DISABLEDFORMBOXES" disabled="">
                                                                </td>
                                                                <td align="right"> &nbsp;NZD&nbsp;
                                                                    <input name="StatementLimitNZD" id="StatementLimitNZD" value="375000" size="20" disabledformboxes="DISABLEDFORMBOXES" disabled="">
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input name="CreditWarningOptOut" type="checkbox" id="CreditWarningOptOut" value="1">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Standard&nbsp;Interest&nbsp;Rate</td>
                                                <td>
                                                    <input name="StandardInterestRate" id="StandardInterestRate" value="9" size="20">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Default Interest Rate</td>
                                                <td>
                                                    <input name="DefaultInterestRate" id="DefaultInterestRate" value="20" size="20">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right">Interest Free Days</td>
                                                <td>
                                                    <input name="IntFreeDays" id="IntFreeDays" value="0" size="10">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" valign="top" style="vertical-align:top;">Payment / Credit Terms</td>
                                                <td><a href="#" class="addpaymentcredittermsnotelink">Add Payment / Credit Term Note</a>
                                                    <br>
                                                    <br>
    ...
    <div class="copybar">2018 Nichibo Japan Trading Co., Ltd. All Rights Reserved.</div>
    </div>
</body>
